...
const Cursor = ({ color, shake, triggerShake, top, left, visible, seedCount, isTopTurn }) => {
  const svgCursor = (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 440">
	    ...
	    <path fill={color} d="M20 200H60V220H80v60h20V20h40V200h20V120h40v80h20V140h40v80h20V160h20V180h20V320H300v60H280v40H120V380H100V340H80V300H60V260H40V240H20V200"/>
    </svg>
  );
